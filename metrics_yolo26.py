...
parser.add_argument('--model_type', type=str, default='ultralytics', help='Type of the detection model')
parser.add_argument('--model_path', type=str,
                    default=r'/root/xxx.pt',
                    help='Path to the model weights')
parser.add_argument('--confidence_threshold', type=float, default=0.25, help='Confidence threshold for the model')
